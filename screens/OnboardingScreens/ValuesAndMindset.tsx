...
const ValuesAndMindset= ({navigation}:any) => {
  const { dispatch } = useStateContext();
    const [selectedText, setSelectedText] = useState('Community and collaboration');
    const texts = ["Growth and continuous improvement", "Innovation and creativity", "Leadership and impact", "Balance and wellness","Community and collaboration"];
    ...
    const hanndleClick=()=>{
      ...
      {
        dispatch({ type: 'ADD_VALUE', payload: { key: 'values_and_mindset', value: selectedText } });
        navigation.navigate('connectiongoals')
      }
    }
  return (
    ...
    <LinearGradient
      ...
      <Text style={styles.headerText}>Values and Mindset</Text>
      </View>
      ...
      <View style={{flex:1}}>
       ...
       <View style={styles.container}>
          ...
          <Text style={styles.text}>What values drive you? Select the principles that resonate most with you.</Text>
     </View>
     <View style={{flex:1}}>
...
export default ValuesAndMindset
