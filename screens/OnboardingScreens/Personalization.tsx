...
const Personalization= ({navigation}:any) => {
    const { dispatch } = useStateContext();
    const [selectedText, setSelectedText] = useState('Analytical and tech-savvy');
    const texts = ["Curious and always learning", "Creative and expressive", "Analytical and tech-savvy", "Entrepreneurial and a risk-taker","Social and community-focused"];
    ...
    const hanndleClick=()=>{
      ...
      {
        dispatch({ type: 'ADD_VALUE', payload: { key: 'personalization', value: selectedText } });
  ...
  return (
    ...
    <LinearGradient
      ...
      <Text style={styles.headerText}>Detailed Personalization</Text>
      </View>
      ...
      <View style={{flex:1}}>
       ...
       <View style={styles.container}>
          ...
          <Text style={styles.text}>To tailor your experience, tell us more about what excites you. Choose the options that best describe you.</Text>
     </View>
     <View style={{flex:1}}>
