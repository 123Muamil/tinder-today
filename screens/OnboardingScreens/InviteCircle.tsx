...
const InviteCircle= ({navigation}:any) => {
    const [selectedText, setSelectedText] = useState('Maybe later');
    const texts = ["Invite from Contacts", "Invite from Instagram.","Invite from other platforms.","Maybe later"];
  ...
  return (
    ...
    <LinearGradient
      ...
      <Text style={styles.headerText}>Invite Your Circle</Text>
      </View>
      ...
      <View style={{flex:1}}>
       ...
       <StepIndicatorComponent currentStep={10}/>
       <View style={styles.container}>
        
          <Text style={styles.text}>Want to make your Today experience even more personal? Invite your friends to join the journey and grow together.</Text>
     </View>
